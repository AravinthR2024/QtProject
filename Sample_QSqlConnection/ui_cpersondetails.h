...
public:
    ...
    void setupUi(QDialog *CPersonDetails)
    {
        ...
        leDisplayName->setFocusPolicy(Qt::NoFocus);
        ...
        leDisplayAge->setFocusPolicy(Qt::NoFocus);
        ...
        leDisplayQualification->setFocusPolicy(Qt::NoFocus);
        ...
        teDisplayAddress->setFocusPolicy(Qt::NoFocus);
